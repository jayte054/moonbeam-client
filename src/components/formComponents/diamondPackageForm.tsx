...
interface UploadDiamondPackageFormProps extends FormikProps<PackageRatesDto> {
...
export const DiamondPackageForm: React.FC<UploadDiamondPackageFormProps> = (props) => {
  ...
  const handleUpload = (formikHelpers: any) =>
    uploadDiamondPackageRates(values, formikHelpers);
  return (
    <div>
      <Form>
        <CustomInput
        ...
        <CustomInput
          label="Item Eleven"
          name="itemEleven"
          value={values.itemEleven}
          onChange={handleChange}
          type="text"
          placeholder="Item Eleven"
          error={touched.itemEleven && errors.itemEleven}
        />{" "}
        <CustomInput
          label="Item Twelve"
          name="itemTwelve"
          value={values.itemTwelve}
          onChange={handleChange}
          type="text"
          placeholder="Item Twelve"
          error={touched.itemTwelve && errors.itemTwelve}
        />{" "}
        <CustomInput
          label="Price"
          name="price"
